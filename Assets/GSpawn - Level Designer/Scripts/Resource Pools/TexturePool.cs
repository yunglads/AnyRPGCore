...
namespace GSPAWN
{
    public class TexturePool : Singleton<TexturePool>
    {
        ...
        public Texture2D wallRule_Segment
        {
            get
            {
                if (_wallRule_Segment == null) _wallRule_Segment = loadUITexture("WallRule_Segment_64");
                return _wallRule_Segment;
            }
        }
        ...
        public Texture2D getModularWallRuleTexture(ModularWallRuleId ruleId)
        {
            if (_wallRuleTextures == null)
            {
                ...
                _wallRuleTextures[(int)ModularWallRuleId.WallSegment]   = wallRule_Segment;
