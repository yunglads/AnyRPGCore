    ...
    public class ModularWallPrefabProfileDbUI : PluginUI
    {
        ...
        private void createProfileSettingsControls(VisualElement parent)
        {
            ...
            imGUIContainer.onGUIHandler         = () =>
            {
                ...
                guiContent.tooltip  = "An example prefab that contains the necessary wall pieces (segment, inner corner & outer corner, etc) to allow the plugin to detect how the pieces fit together.";
                ...
                guiContent.tooltip          = "If checked, pillars will be spawned based on the pillar prefabs that exist inside the example prefab.";
                EditorGUI.BeginChangeCheck();
