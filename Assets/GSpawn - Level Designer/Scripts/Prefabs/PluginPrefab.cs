...
namespace GSPAWN
{
    ...
    public class PluginPrefab : ScriptableObject, IUIItemStateProvider
    {
        ...
        [SerializeField]
        private WallPrefabTag           _tag                                    = WallPrefabTag.None;
        ...
        public WallPrefabTag            tag                 { get { return _tag; } set { UndoEx.record(this); _tag = value; EditorUtility.SetDirty(this); } }
