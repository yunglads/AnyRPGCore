...
namespace GSPAWN
{
    ...
    public class UIPluginPrefabItem : GridViewItem<UIPluginPrefabItemData>
    {
        ...
        protected override void onBuildUI()
        {
            ...
            _tagField = UI.createEnumField(typeof(WallPrefabTag), "_tag", data.prefab.serializedObject, "", icon.tooltip, toolbar);
            _tagField.style.flexGrow = 1.0f;
        ...
        protected override void onInitDataBindings()
        {
            if (_tagField != null)
            {
                VisualElement parent = _tagField.parent;
                int index = parent.IndexOf(_tagField);
                parent.RemoveAt(index);

                _tagField = UI.createEnumField(typeof(WallPrefabTag), "_tag", data.prefab.serializedObject, "", "Allows you to assign a wall tag to this prefab.", parent);
                _tagField.style.flexGrow = 1.0f;
                parent.Insert(index, _tagField);
