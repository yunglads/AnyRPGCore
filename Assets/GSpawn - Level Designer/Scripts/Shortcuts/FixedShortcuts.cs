...
namespace GSPAWN
{
    public static class FixedShortcuts
    {
        ...
        public static bool ui_BeginHotkeyAssignmentOnClick(ClickEvent e)
        {
            return e.clickCount == 2 && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.commandKey && e.button == (int)MouseButton.LeftMouse;
        }
