...
namespace AnyRPG
{
    public class AnyRPGCameraController : ConfiguredMonoBehaviour
    {
        ...
        //private void HandleActionModeInteract()
        //{
        //    // Clear previous highlight
        //    if (actionLookedAtInteractable != null)
        //    {
        //        actionLookedAtInteractable.OnMouseOut();
        //        if (uIManager != null) uIManager.HideToolTip();
        //    }
        //    actionLookedAtInteractable = null;
        //    actionLookedAtCanInteract = false;

        //    if (usedCamera != null)
        //    {
        //        Ray ray = usedCamera.ViewportPointToRay(new Vector3(0.5f, 0.5f, 0f));
        //        Debug.DrawRay(ray.origin, ray.direction * actionInteractDistance, Color.yellow, .1f);
        //        RaycastHit hit;

        //        if (Physics.Raycast(ray, out hit, actionInteractDistance, actionInteractMask))
        //        {
        //            bool isOwnCollider = playerManagerClient?.ActiveUnitController != null
        //                && hit.collider.transform.IsChildOf(playerManagerClient.ActiveUnitController.transform);
        ...
        //                {
        //                    UnitController playerUnit = playerManagerClient?.UnitController;
        //                    bool canInteract = !interactable.NotInteractable
        //                        && interactable.GetCurrentInteractables(playerUnit).Count > 0;

        //                    actionLookedAtInteractable = interactable;
        //                    actionLookedAtCanInteract = canInteract;

        //                    Debug.Log($"currently looked at interactable: {interactable.name}. Can interact = {canInteract}");
        ...
        //                            new Vector2(0.5f, 0f),
        //                            new Vector3(Screen.width * 0.5f, Screen.height * 0.5f + 60f, 0f),
        //                            interactable.CharacterTarget
        //                        );
        //                    }

        //                    if (Input.GetKeyDown(actionInteractKey) && canInteract && playerUnit != null)
        //                    {
        //                        if (interactable.IsInInteractableRange(playerUnit.gameObject))
        //                        {
        ...
        //    // Always runs regardless of raycast result
        //    if (crosshairDot != null)
        //    {
        //        if (actionLookedAtInteractable == null)
        //            crosshairDot.color = crosshairDefaultColor;
        //        else if (actionLookedAtCanInteract)
        //            crosshairDot.color = crosshairInteractColor;
        //        else
        //            crosshairDot.color = crosshairOutOfRangeColor;
        //    }
        //}
