...
namespace AnyRPG {
    [System.Serializable]
    public class WeaponSkillPrerequisite : ConfiguredClass, IPrerequisite {
        ...
        private WeaponSkill prerequisiteSkill = null;
        ...
        public void SetupScriptableObjects(SystemGameManager systemGameManager, string ownerName) {
            ...
            if (prerequisiteName != null && prerequisiteName != string.Empty) {
                WeaponSkill tmpPrerequisiteSkill = systemDataFactory.GetResource<WeaponSkill>(prerequisiteName);
