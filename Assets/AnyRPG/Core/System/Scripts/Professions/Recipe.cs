...
namespace AnyRPG {
    ...
    public class Recipe : DescribableResource {
        ...
        [Tooltip("Base XP before any scaling is applied")]
        [SerializeField]
        ...
        public int RecipeLevel { get => recipeLevel; set => recipeLevel = value; }
        ...
        public override void SetupScriptableObjects(SystemGameManager systemGameManager) {
            ...
            //if (skill.resourceName != string.Empty)
            //{
            //    skill = systemDataFactory.GetResource<Skill>(skill.ResourceName);
            //    if (skill == null)
            //    {
            //        Debug.LogError($"Recipe.SetupScriptableObjects(): Could not find skill : {skill.ResourceName} while inititalizing {ResourceName}.  CHECK INSPECTOR");
            //    }
            //}
